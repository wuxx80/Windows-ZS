...
namespace WinPE_Client.Models
{
    ...
    /// <summary>步骤导航项（U盘制作 四步向导）</summary>
    public class UdiskStepNav : ObservableObject
    {
        public int Index { get; set; }
        public string Name { get; set; } = "";
        ...
        {
            get => _state;
            set { _state = value; OnPropertyChanged(); OnPropertyChanged(nameof(Icon)); OnPropertyChanged(nameof(IsCurrent)); OnPropertyChanged(nameof(IsCompleted)); }
        }
